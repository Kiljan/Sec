- [PENETRATION\_TEST](#penetration_test)
  - [PASSIVE\_IG](#passive_ig)
    ...
    - [Email\_Harvesting](#email_harvesting)
    - [Theharvester](#theharvester)
    - [Additional\_Resource](#additional_resource)
  - [ACTIVE\_IG](#active_ig)
    - [Types of records](#types-of-records)
    - [DNS check nslookup](#dns-check-nslookup)
    - [dnsrecon command](#dnsrecon-command)
    - [host command](#host-command)
  - [SCANNING METHODOLOGY](#scanning-methodology)
    - [CORE](#core)
    - [tcpdump SCANNING TOOL](#tcpdump-scanning-tool)
  - [ENUMERATION](#enumeration)
  - [SNIFFING](#sniffing)
  - [EVASION OR NOT](#evasion-or-not)
  - [ATTACKING A SYSTEM](#attacking-a-system)
    - [WINDOWS](#windows)
    - [LINUX](#linux)
    - [SYSTEMS (and John)](#systems-and-john)
  - [PRIVILEGE ESCALATION](#privilege-escalation)
  - [EXECUTING APPLICATION](#executing-application)
  - [HIDING FILES AND COVERING TRACK](#hiding-files-and-covering-track)
  - [ROOTKITS](#rootkits)
  ...
  - [NOTES](#notes)
    - [SPARTA](#sparta)
    - [PORT TO REMEMBER](#port-to-remember)
    - [NETWORK CLASSES IPv4](#network-classes-ipv4)
